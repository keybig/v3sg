...
export class Account extends Entity {
  ...
  get totalOpenPositions(): BigInt {
    let value = this.get("totalOpenPositions");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set totalOpenPositions(value: BigInt) {
    this.set("totalOpenPositions", Value.fromBigInt(value));
  }

  get totalClosedPositions(): BigInt {
    let value = this.get("totalClosedPositions");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set totalClosedPositions(value: BigInt) {
    this.set("totalClosedPositions", Value.fromBigInt(value));
  }
...
export class AccountAggregateStat extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save AccountAggregateStat entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type AccountAggregateStat must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("AccountAggregateStat", id.toString(), this);
    }
  }

  static loadInBlock(id: string): AccountAggregateStat | null {
    return changetype<AccountAggregateStat | null>(
      store.get_in_block("AccountAggregateStat", id),
    );
  }

  static load(id: string): AccountAggregateStat | null {
    return changetype<AccountAggregateStat | null>(
      store.get("AccountAggregateStat", id),
    );
  }
  ...
  get positionPnl(): BigInt {
    let value = this.get("positionPnl");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set positionPnl(value: BigInt) {
    this.set("positionPnl", Value.fromBigInt(value));
  }

  get accountPnl(): BigInt {
    let value = this.get("accountPnl");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set accountPnl(value: BigInt) {
    this.set("accountPnl", Value.fromBigInt(value));
  }
...
export class Trade extends Entity {
  ...
  get averageEntryPrice(): BigInt {
    let value = this.get("averageEntryPrice");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set averageEntryPrice(value: BigInt) {
    this.set("averageEntryPrice", Value.fromBigInt(value));
  }
...
export class Position extends Entity {
  ...
  get realizedPnlWithFees(): BigInt {
    let value = this.get("realizedPnlWithFees");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set realizedPnlWithFees(value: BigInt) {
    this.set("realizedPnlWithFees", Value.fromBigInt(value));
  }
...
export class PositionReference extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PositionReference entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type PositionReference must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("PositionReference", id.toString(), this);
    }
  }

  static loadInBlock(id: string): PositionReference | null {
    return changetype<PositionReference | null>(
      store.get_in_block("PositionReference", id),
    );
  }

  static load(id: string): PositionReference | null {
    return changetype<PositionReference | null>(
      store.get("PositionReference", id),
    );
  }
...
export class Action extends Entity {
  ...
  get accruedFunding(): BigInt | null {
    let value = this.get("accruedFunding");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
  ...
  set accruedFunding(value: BigInt | null) {
    if (!value) {
      this.unset("accruedFunding");
    } else {
      this.set("accruedFunding", Value.fromBigInt(<BigInt>value));
    }
  }
  ...
  set referralFees(value: BigInt | null) {
    if (!value) {
      this.unset("referralFees");
    } else {
      this.set("referralFees", Value.fromBigInt(<BigInt>value));
    }
  }
  ...
  set settler(value: Bytes | null) {
    if (!value) {
      ...
      this.set("settler", Value.fromBytes(<Bytes>value));
    }
  }

  get actionTimestamp(): BigInt {
    let value = this.get("actionTimestamp");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set actionTimestamp(value: BigInt) {
    this.set("actionTimestamp", Value.fromBigInt(value));
  }
